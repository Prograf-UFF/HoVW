...
python src/kmeans-nodes.py -i "Master/datasetOutput/descriptor/" -o "Master/datasetOutput" -c 300 -l "Master/datasetOutput/logs"
# python src/kmeans-nodes-test.py -i "Master/datasetOutput/test/descriptor/" -o "Master/datasetOutput/test" -c "Master/data/kme-clusters2.clr" -l "Master/datasetOutput/logs"
...
python src/trees-distance.py -i "Master/data/img_trees_labeled-train.pickle" -c "Master/data/kme-clusters-cdm.npy" -m "Master/data/tree_distances_matrix-train.npy" -d "Master/data/apted_custom_dist.pickle" -p 4

python src/meanshift-graphs.py "Master/data/tree_distances_matrix-train.npy" "Master/data/trees_clustered" 0.3 "Master/data/img_trees_labeled-train.pickle"

python src/assign-tree-label.py "Master/data/img_trees_labeled-train.pickle" "Master/data/trees_clustered_vq-train.npy"
python src/meanshift-graphs-test.py "Master/data/img_trees_labeled-test.pickle" "Master/data/trees_clustered_codebook.npz" "Master/data/kme-clusters-cdm.npy" "Master/data/trees_clustered_centers.npy"
...
#EXTRAS -- apenas visualização, não levar em consideração no pipeline
...
python src/precison_recall_test.py 20